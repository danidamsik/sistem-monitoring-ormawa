...
<div x-show="showDetail" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
    ...
    <div @click.away="showDetail = false" x-show="showDetail"
        ...
        <!-- Header -->
        <div
            class="bg-gradient-to-b from-purple-900 to-purple-800 px-4 sm:px-8 py-4 sm:py-6 relative overflow-hidden flex-shrink-0">
            <div class="absolute inset-0 bg-white opacity-5"></div>
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-3 sm:gap-4" x-show="showDetail"
                    x-transition:enter="transition ease-out duration-500 delay-100"
                    x-transition:enter-start="opacity-0 -translate-x-10"
                    x-transition:enter-end="opacity-100 translate-x-0">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center ring-2 ring-white ring-opacity-30">
                        <i class="fa-solid fa-circle-info text-white text-lg sm:text-2xl"></i>
                    </div>
                    <div>
                        <h2 class="text-lg sm:text-2xl font-bold text-white">Detail Kegiatan</h2>
                        <p class="text-blue-100 text-xs sm:text-sm mt-0.5">Informasi lengkap pelaksanaan kegiatan</p>
                    </div>
                </div>
                <button @click="showDetail = false" x-show="showDetail"
                    ...
                    class="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-xl hover:bg-white hover:bg-opacity-20 transition-all duration-200 group flex-shrink-0">
                    <i
                        class="fa-solid fa-xmark text-white text-xl sm:text-2xl group-hover:rotate-90 transition-transform duration-200"></i>
                </button>
            </div>
        </div>
        ...
        <div class="p-4 sm:p-8 overflow-y-auto flex-1">
            <div class="space-y-4 sm:space-y-5">
                ...
                <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-200"
                    ...
                    class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-blue-100 shadow-sm hover:shadow-md transition-shadow duration-200">
                    ...
                    <p class="text-gray-900 font-semibold text-base sm:text-lg pl-0 sm:pl-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-300"
                        ...
                        x-transition:enter-end="opacity-100 translate-x-0"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                        ...
                        <p class="text-gray-900 font-medium text-sm sm:text-base pl-0 sm:pl-10">
                    ...
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-350"
                        x-transition:enter-start="opacity-0 translate-x-4"
                        x-transition:enter-end="opacity-100 translate-x-0"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-red-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-400"
                        x-transition:enter-start="opacity-0 -translate-x-4"
                        x-transition:enter-end="opacity-100 translate-x-0"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-green-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                    ...
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-450"
                        x-transition:enter-start="opacity-0 translate-x-4"
                        x-transition:enter-end="opacity-100 translate-x-0"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-purple-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-500"
                        x-transition:enter-start="opacity-0 -translate-x-4"
                        x-transition:enter-end="opacity-100 translate-x-0"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-indigo-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                    ...
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-550"
                        x-transition:enter-start="opacity-0 translate-x-4"
                        x-transition:enter-end="opacity-100 translate-x-0"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-teal-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-600"
                        ...
                        class="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-4 sm:p-5 border-2 border-emerald-200 shadow-sm hover:shadow-md transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                        ...
                        <p class="text-emerald-900 font-bold text-lg sm:text-xl pl-0 sm:pl-10">
                            Rp 75.000.000
                        </p>
                    </div>
                    ...
                    <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-650"
                        x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
                        class="bg-white rounded-2xl p-4 sm:p-5 border-2 border-gray-100 shadow-sm hover:shadow-md hover:border-amber-200 transition-all duration-200">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                        ...
                        <div class="pl-0 sm:pl-10">
                            <span
                                class="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-bold bg-green-100 text-green-700 shadow-sm">
                ...
                <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-700"
                    x-transition:enter-start="opacity-0 translate-y-4"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    class="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-4 sm:p-5 border-2 border-orange-200 shadow-sm">
                    <div class="flex items-center gap-2 mb-3">
                        <div
                    ...
                    <p class="text-gray-800 leading-relaxed pl-0 sm:pl-10 text-sm sm:text-base">
        ...
        <div x-show="showDetail" x-transition:enter="transition ease-out duration-500 delay-750"
            ...
            class="px-4 sm:px-8 py-4 sm:py-5 bg-gradient-to-r from-gray-50 to-gray-100 border-t-2 border-gray-200 flex justify-end flex-shrink-0">
            <button @click="showDetail = false"
                class="w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl text-white font-semibold transition-all duration-200 flex items-center justify-center gap-2 sm:gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95">
                <i class="fa-solid fa-check text-base sm:text-lg"></i>
                <span>Tutup</span>
            </button>
        </div>
